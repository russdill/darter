...
value=V=V(en) > 0 ?
  (V(in) > 0 ? {rising_waveform_max} : 0) : 0
}
N 59700 43900 60900 43900 4
{
T 60500 44000 5 10 1 1 0 0 1
netname=pad
}
C 59500 45000 1 270 0 current-1.sym
{
T 60500 44400 5 10 0 0 270 0 1
device=CURRENT_SOURCE
T 59200 44200 5 10 1 1 0 0 1
refdes=B_pu
T 54200 45800 5 10 1 1 0 0 1
value=I=V(Ipu)*((I(Vfx_pu0)-I(V_comp_pu0))*V(I1_pu)+(I(Vfx_pu1)-I(V_comp_pu1))*V(I2_pu))/(V(I2u)*V(I4_pu)-V(I1_pu)*V(I3_pu))
}
C 59900 42800 1 90 0 current-1.sym
{
T 58900 43400 5 10 0 0 90 0 1
device=CURRENT_SOURCE
T 59200 43500 5 10 1 1 0 0 1
refdes=B_pd
T 54200 41800 5 10 1 1 0 0 1
value=I=V(Ipd)*((I(Vfx_pd0)-I(V_comp_pd0))*V(I4_pd)+(I(Vfx_pd1)-I(V_comp_pd1))*V(I3_pd))/(V(I2_pd)*V(I4_pd)-V(I1_pd)*V(I3_pd))
}
C 59900 42600 1 180 0 vss-1.sym
C 59500 45200 1 0 0 vdd-1.sym
N 59700 44100 59700 43700 4
N 59700 45000 59700 45200 4
N 58800 45100 59700 45100 4
N 59700 42600 59700 42800 4
N 58800 42700 59700 42700 4
...
C 58800 44400 1 0 1 vcvs-1.sym
{
T 58600 45450 5 10 0 0 0 6 1
device=SPICE-vcvs
T 58200 45250 5 10 1 1 0 6 1
refdes=X_pu
T 58600 45650 5 10 0 0 0 6 1
symversion=0.1
T 58100 44150 5 10 1 1 0 5 1
value=pullup0 spec={spec}
}
N 58800 44500 59000 44500 4
N 59000 43300 59000 44500 4
N 59000 43900 59700 43900 4
C 58800 42600 1 0 1 vcvs-1.sym
{
T 58600 43650 5 10 0 0 0 6 1
device=SPICE-vcvs
T 58200 43450 5 10 1 1 0 6 1
refdes=X_pd
T 58600 43850 5 10 0 0 0 6 1
symversion=0.1
T 58500 42550 5 10 1 1 0 5 1
value=pulldown0 spec={spec}
}
N 58800 43300 59000 43300 4
...
C 51700 38700 1 0 0 gnd-1.sym
N 50300 36800 50200 36800 4
C 48300 45200 1 270 0 voltage-3.sym
{
T 49000 45000 5 8 0 0 270 0 1
device=VOLTAGE_SOURCE
...
C 45300 45200 1 270 0 voltage-3.sym
{
T 46000 45000 5 8 0 0 270 0 1
device=VOLTAGE_SOURCE
...
C 45300 45200 1 0 0 generic-power.sym
{
T 45500 45450 5 10 1 1 0 3 1
net=Vpc:1
}
C 48300 45200 1 0 0 generic-power.sym
{
T 48500 45450 5 10 1 1 0 3 1
net=Vgc:1
}
...
C 57200 44200 1 0 0 gnd-1.sym
N 56700 45100 57300 45100 4
{
T 56900 45100 5 10 1 1 0 0 1
netname=Ipu
}
N 56700 42700 57300 42700 4
{
T 56900 42700 5 10 1 1 0 0 1
netname=Ipd
}
C 50900 37800 1 180 1 current-1.sym
{
T 51500 36800 5 10 0 0 180 6 1
device=CURRENT_SOURCE
...
C 48200 37400 1 0 0 current-1.sym
{
T 48800 38400 5 10 0 0 0 0 1
device=CURRENT_SOURCE
...
B 53800 41300 10700 5100 3 0 0 2 200 200 0 -1 -1 -1 -1 -1
...
value=V=V(en) > 0 ?
  (V(in) > 0 ? 0 : {falling_waveform_max}) : 0
}
...
Fixture 1
T 53800 46500 9 10 1 0 0 0 1
IBIS Gate Model
T 36700 45000 8 10 1 0 0 0 1
dist-license=GPLv3
T 36706 45200 8 10 1 0 0 0 1
author=Russ Dill <Russ.Dill@asu.edu>
C 48300 43200 1 270 0 voltage-3.sym
{
T 49000 43000 5 8 0 0 270 0 1
device=VOLTAGE_SOURCE
T 48800 42700 5 10 1 1 0 0 1
refdes=V_pu
T 48800 42500 5 10 1 1 0 0 1
value=DC {pullup_reference}
}
C 45300 43200 1 270 0 voltage-3.sym
{
T 46000 43000 5 8 0 0 270 0 1
device=VOLTAGE_SOURCE
...
C 45400 42000 1 0 0 gnd-1.sym
C 48400 42000 1 0 0 gnd-1.sym
C 45300 43200 1 0 0 generic-power.sym
{
T 45500 43450 5 10 1 1 0 3 1
net=Vpd:1
}
C 48300 43200 1 0 0 generic-power.sym
{
T 48500 43450 5 10 1 1 0 3 1
net=Vpu:1
}
...
C 60700 37800 1 180 1 current-1.sym
{
T 61300 36800 5 10 0 0 180 6 1
device=CURRENT_SOURCE
...
C 58000 37400 1 0 0 current-1.sym
{
...
C 50900 30900 1 180 1 current-1.sym
{
T 51500 29900 5 10 0 0 180 6 1
device=CURRENT_SOURCE
...
N 51800 31500 52000 31500 4
{
T 51800 31500 5 10 1 1 0 0 1
netname=I3_pd
}
...
C 48200 30500 1 0 0 current-1.sym
{
...
C 60700 30900 1 180 1 current-1.sym
{
T 61300 29900 5 10 0 0 180 6 1
device=CURRENT_SOURCE
...
N 61600 31500 61800 31500 4
{
T 61600 31500 5 10 1 1 0 0 1
netname=I4_pd
}
...
C 58000 30500 1 0 0 current-1.sym
{
T 58600 31500 5 10 0 0 0 0 1
device=CURRENT_SOURCE
...
C 47100 41900 1 0 0 gnd-1.sym
N 47000 42200 47200 42200 4
{
